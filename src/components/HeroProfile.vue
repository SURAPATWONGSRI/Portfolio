  ...
  <div class="hero bg-base-200 min-h-screen relative overflow-hidden">
    ...
    <div class="hero-content flex-col lg:flex-row gap-10 lg:gap-16 px-6 lg:px-20 relative">
      ...
      <div class="text-center lg:text-left">
        <h2
          class="text-3xl lg:text-4xl font-extrabold text-success mb-4 animate__animated animate__fadeInDown"
        >
          👋 สวัสดีครับ, ผม สุรพัศ วงศรี
        </h2>
        <p class="py-4 text-lg text-gray-400 animate__animated animate__fadeInUp animate__delay-1s">
        ...
        <RouterLink
          class="btn btn-neutral text-white font-light shadow-lg hover:shadow-xl transition-shadow duration-300"
          :to="{ hash: '#contact' }"
        >
